...
'''Using another method from doc class, you can also find tags, along with indexing to select a specifc one'''
foundTags = doc.find_all('div')[0]

'''Then you can find any nested tag, as main is contained within the fist div'''
